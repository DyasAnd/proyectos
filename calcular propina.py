...
total = float(input("Por favor ingrese cual es la factura total de hoy: $"))
...
while True:
    ...
    if opcion == "1":
        ...
        print("el porcnetaje que desea ingresar no esta en el menu, elija 1, 2 o 3.")

propina = round(total * porcentaje_propina, 2)
